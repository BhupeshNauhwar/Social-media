                ...
                &#8203;
                    ...
                    aria-labelledby='modal-headline'>
                        ...
                        onSubmit={handleSubmit(onSubmit)}>
                            ...
                            type='text'
                            styles='w-full'
                            register={register("location",{required:" First Name Required"
                            ...
                            type='text'
                            styles='w-full'
                            register={register("location",{required:" Last Name required"
                            ...
                            type='text'
                            styles='w-full'
                            register={register("location",{required:" Profession required"
